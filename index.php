...
<body>
    <header class="header" id="header">
        <div class="logo-header">
            <img src="media/logo.png" alt="Logo Cursos Fodas">
        </div>
    </header>
    ...
    <div class="container c1">
        ...
        <div class="cursos sites">
            <div class="container-cursos">
                ...
                <button class="card alura-imercao-java <?php if ($data_expira >= $data) echo $textMiddle; ?>" onclick="window.open('pages/Alura5', '_blank')">
                    <?php if ($data_expira >= $data) echo $textNew; ?>
                    <h2>Imersão Java_</h2>
                </button>
                <?php if ($data_expira >= $data) echo $textBottom; ?>

                <?php if ($data_expira2 >= $data) echo $textTop; ?>
                <button class="card enem <?php if ($data_expira2 >= $data) echo $textMiddle; ?>" onclick="window.open('pages/ENEM', '_blank')">
                    <?php if ($data_expira2 >= $data) echo $textNew; ?>
                    <h2>ENEM</h2>
                </button>
                <?php if ($data_expira2 >= $data) echo $textBottom; ?>

                <?php if ($data_expira2 >= $data) echo $textTop; ?>
                <button class="card maratona-explorer <?php if ($data_expira2 >= $data) echo $textMiddle; ?>" onclick="window.open('pages/Explorer', '_blank')">
                    <?php if ($data_expira2 >= $data) echo $textNew; ?>
                    <h2>Maratona Explorer</h2>
                </button>
                <?php if ($data_expira2 >= $data) echo $textBottom; ?>

                <button class="card alura-imercao-dados" onclick="window.open('pages/Alura4', '_blank')">
                    <h2>Imersão Dados_</h2>
                </button>
                <button class="card alura-imercao-react" onclick="window.open('pages/Alura3', '_blank')">
                    <h2>Imersão React_</h2>
                </button>
                <button class="card kenzie" onclick="window.open('pages/Kenzie', '_blank')">
                    <h2>Kenzie</h2>
                </button>
                <button class="card nlw-together" onclick="window.open('pages/NextLevel/', '_blank')">
                    <h2>NLW Together</h2>
                </button>
                <button class="card hashtag" onclick="window.open('pages/Hashtag/', '_blank')">
                    <h2>Hashtag</h2>
                </button>
                <button class="card alura-imercao-dev-2" onclick="window.open('pages/Alura2/', '_blank')">
                    <h2>Imersão Dev_ - 2021-2</h2>
                </button>
                    <button class="card alura-imercao-dev-1" onclick="window.open('pages/Alura/', '_blank')">
    ...
    <div class="container c3">
        ...
        <div class="cursos drive">
            <div class="container-cursos">
                <?php if ($data_expira >= $data) echo $textTop; ?>
                <button class="card estudonauta <?php if ($data_expira >= $data) echo $textMiddle; ?>" onclick="window.open('https://drive.google.com/drive/folders/124gE4M-bodLHuSb1yiPTIxKpCSzv0S8o', '_blank')">
                    <?php if ($data_expira >= $data) echo $textNew; ?>
                    <h2>Estudonauta - Programação Básica</h2>
                </button>
                <?php if ($data_expira >= $data) echo $textBottom; ?>
